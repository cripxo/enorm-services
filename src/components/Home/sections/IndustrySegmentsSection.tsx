...
export const IndustrySegmentsSection = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[1820px] mx-auto flex flex-col items-center justify-center py-12 md:py-[90px] px-6 md:px-12 lg:px-[250px] rounded-lg bg-[linear-gradient(180deg,rgba(219,230,252,1)_0%,rgba(255,255,255,1)_100%)]">
        <header
        ...
        >
          ...
          <p className="[font-family:'Public_Sans',Helvetica] font-normal text-[#666666] text-base md:text-lg text-center leading-[30px] max-w-[700px]">
            Von modernen Bürogebäuden bis hin zu Industrieeinrichtungen - wir
            bieten umfassende Services für alle Anforderungen.
          </p>
        </header>
        ...
        <ul className="flex flex-wrap justify-center gap-3 md:gap-5">
          ...
          <li className="flex w-14 h-14 md:w-16 md:h-16 items-center justify-center bg-[#164ac8] rounded-full list-none hover:bg-[#1a56e0] transition-colors duration-300">
            <button
              type="button"
